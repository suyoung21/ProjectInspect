...
public class MP3Recorder {
	 ...
	 */
	private static final int DEFAULT_SAMPLING_RATE = 22050;//模拟器仅支持从麦克风输入8kHz采样率;44100
	...
	public void start() throws IOException {
		...
		if(AudioRecord.RECORDSTATE_RECORDING != mAudioRecord.getRecordingState()){
			Log.e("MP3Recorder", "Chency RecordingState ERROR:" + mAudioRecord.getRecordingState());
			throw new IllegalStateException("AudioRecord is used by other APPs");
		}
		new Thread() {
